    ...
    <div class="reports-container">
        ...
        <div class="reports-grid">
            <div class="report-card">
                ...
                <a href="clerkReportClass.php" class="btn btn-primary">View Report</a>
            </div>
            <div class="report-card">
                <h2>Staff Information</h2>
                <p>Access comprehensive staff profiles, including qualifications, and responsibilities, </p>
                <a href="clerkReportStaff.php" class="btn btn-primary">View Report</a>
            </div>
            <div class="report-card">
                ...
                <a href="clerkReportStudent.php" class="btn btn-primary">View Report</a>
            </div>
            <div class="report-card">
                <h2>Former Student Information</h2>
                <p>Review student data, including personal information,guardian contact.</p>
                <a href="clerkReportFormerStudent.php" class="btn btn-primary">View Report</a>
            </div>
        </div>
    </div>
</body>
