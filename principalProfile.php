...
// Fetch principal details from database based on session variable
$staffID = $_SESSION['userID'];

// Prepare and execute SQL query to retrieve principal details
$stmt = $conn->prepare("
    SELECT *
    FROM staff
    WHERE staffID = ?
...
<body>
    <div class="profile-container">
        ...
        <div class="btn-container">
            <a href="principalUpdate.php" class="btn btn-primary">Update Profile</a>
        </div>
    </div>
</body>
</html>